...
(function ($) {
  ...
  $(document).ready(function () {
    // Initially, make the elements with class .hide-on-menu-open visible
    var hideElements = $(".hide-on-menu-open");
    hideElements.show();

    // Your existing click event handler for the .onovo-menu-btn
    $(".onovo-menu-btn").on("click", function () {
      ...
      if (obj.hasClass("btn--active")) {
        ...
        // Show the elements with class .hide-on-menu-open when closing the menu
        hideElements.show();
      } else {
        // Menu is opening
        ...
        setTimeout(function () {
          ...
          // Hide the elements with class .hide-on-menu-open when opening the menu
          hideElements.hide();
        }, 600);
      }
      return false;
    ...
    // Add click event handler for menu links to scroll to sections
    $(".onovo-menu-nav a").on("click", function (e) {
      e.preventDefault(); // Prevent the default behavior of the anchor link
      var targetId = $(this).attr("href"); // Get the href attribute of the clicked link

      // Close the menu
      $(".onovo-menu-btn.btn--active").removeClass("btn--active");
      $(".onovo-menu-popup").removeClass("menu--visible");
      $("body").removeClass("onovo--noscroll");
      $(".onovo-header").removeClass("header--active");

      // Show the elements with class .hide-on-menu-open when clicking a menu link
      hideElements.show();

      // Scroll to the target section
      $("html, body").animate(
        {
          scrollTop: $(targetId).offset().top - $(".onovo-header").height(),
        },
        1000
      );
    });
